<div id="contact-container" class='main-contain' style="margin:0;">
    <div id="contact-image" style="width:815px;margin:10px auto;float:none">
        <img src="/img/pp_contact.png">
        <!-- <div class="photocredit">Photo courtesy of <a href="http://www.mattdeturck.com/" target="_blank">Matt DeTurck</a></div> -->
    </div>
    <div id="contact-copy" style="float:none; width:inherit;margin:25px 60px 0px 60px;text-align:center;">
        <h2>Contact</h2>
