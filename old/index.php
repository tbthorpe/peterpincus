				...
				<h1 style="position:absolute;text-align:left;left:0px;"><span class="menu index" id="home"><b>PETER</b>pincus</span></h1>
					<div id="nav" style="position:absolute;top:40px;">
						<ul>
							...
							<li id="something" class="menu off">STATEMENT</li>
						</ul>
					</div>
				</div>
				
				<div id="content" class="scroll-pane">
					My website is getting completely rebuilt!  Check back soon for changes and updates.<br/>
					If you want to get in touch with me, email me here: <a href="mailto:pjpincus1@gmail.com">pjpincus1@gmail.com</a><br/>
