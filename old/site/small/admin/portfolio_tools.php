		...
		if ($num != ''){
			...
			while ($i < $num) {
				...
				$numpics=mysql_numrows($result2);
					...
					echo "<td width=7%><img src=\"images/edit.png\" onClick=\"showEdit('row".$i."edit')\">&nbsp;<img src=\"images/delete.png\" onClick=\"removePost('portfolio',$id);\"></td>";
...
function displayPortfolioAdd($msg){
		echo "<BR><br><span style='font-size:15pt'><b><center>Current Portfolio</center></b></span>";
	?>
			<a href=# onClick="addNew('addNew')">+ Add new piece into the portfolio</a>
			<div id="addNew"  class="newPost">
				<form id="newsForm" action="admin_portfolio.php" method="POST" enctype="multipart/form-data">
					<table border=0px width=100% align=center cellpadding="5">
						<tr>
...
function putPortfolioInside(){
	echo "<BR><span style='font-size:15pt'><b><center>Current Portfolio Page</center></b></span><br><br>";
	displayPortfolioAdd("");
...
function displayBoxForm($which, $section){
	$row = $which.$section;
	echo "<BR><span style='font-size:15pt'><b><center>Current $section Box</center></b></span>";
	?>
				...
				<form id="newsForm" action="admin_portfolio.php" method="POST" enctype="multipart/form-data">
					...
					<input type="hidden" name="ppid" value=<?php echo $ppid ?>>
						<?php 
							...
							echo "<a href=\"images/portfolio_images_thumbs/".$realpic."\" rel=\"lightbox\"><img src=\"images/portfolio_images_thumbs/".$realpic."\"></a><BR>"; 
		...
		if ($num != ''){
			...
			while ($i < $num) {
				...
				$numpics=mysql_numrows($result2);
					...
					echo "<td width=35%>".$title."</td>";
					echo "<td width=52% title=\"".$text."\">".substr(stripslashes($text),0,100)."...</td>";
					echo "<td width=7%><img src=\"images/edit.png\" onClick=\"showEdit('row".$i.$which.$section."edit')\">&nbsp;<img src=\"images/delete.png\" onClick=\"removePost('portfolio_page',$id);\"></td>";
